...
class DesaController extends Controller
{
    ...
    {
        $provinces = Provinsi::orderBy('nama_provinsi')->get();
        ...
        return view('admin.reference.desa.create', compact('provinces', 'kecamatans'));
    }
    ...
    public function edit(string $id)
    {
        ...
        // Include ALL kecamatans for editing (even if status is inactive)
        // So old data can still be edited
        $kecamatans = Kecamatan::with(['kabupaten', 'kabupaten.provinsi'])
            ->orderBy('nama_kecamatan')
            ->get();

        return view('admin.reference.desa.edit', compact('desa', 'provinces', 'kecamatans'));
    }
