...
<div class="content-wrapper">
    <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-md-8">
                <h1 class="h3 mb-0">Tambah Testimoni Baru</h1>
                <p class="text-muted">Isi data testimoni yang akan ditampilkan di halaman utama</p>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('kesan_pesan') is-invalid @enderror"
                                          id="kesan_pesan" name="kesan_pesan" rows="4" required>{{ old('kesan_pesan') }}</textarea>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <img id="preview-foto" src="{{ asset('images/default-avatar.png') }}"
