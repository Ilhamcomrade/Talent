...
<head>
    ...
    <title>Tambah Benefit Baru</title>
...
<body class="bg-light">
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold">Tambah Benefit Baru</h3>
        </div>

        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('company.benefits.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                  ...
                                  rows="4"
                                  required
                                  placeholder="Jelaskan detail benefit yang diberikan...">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Simpan Benefit
                        </button>
                    </div>
                </form>
            </div>
